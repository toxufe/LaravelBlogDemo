...
<form class="form-horizontal" method="post" action="/article">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input value="{{ old('title') }}" type="text" class="form-control" id="title" name="title" placeholder="标题">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input value="{{ old('abstract') }}" type="text" class="form-control" id="abstract" name="abstract" placeholder="摘要">
